...
use crate::params_sdiff::{ParamsSDiff, SDiffParseOk};
...
/// Entry into sdiff.
///
/// # TODO: This is very basic and the return codes are wrong (always 'Equal').
///
...
/// * The return code is always Equal
pub fn sdiff_compare(params: &ParamsSDiff) -> Result<SDiffOk, SDiffError> {
    ...
    // TODO side_diff does not return any information if equal or not
